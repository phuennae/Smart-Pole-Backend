...
<head>
    ...
    <style>
        ...
        .btn-alarm { background-color: #ffc107; color: #000; font-weight: bold; border: 2px solid #dc3545; }
...
// ฟังก์ชันส่งสัญญาณเตือนภัยพร้อมยืนยัน
function sendAlarmBroadcast() {
    if (confirm("⚠️ คำเตือน: คุณกำลังจะส่งสัญญาณเตือนภัยไปยังโหนดทุกตัว!\n\nระบบจะสั่งเล่นไฟล์ 'alarm007.mp3' พร้อมกันทั้งหมด ยืนยันหรือไม่?")) {
        ...
        actionInput.value = 'play';

        const fileInput = document.createElement('input');
        fileInput.type = 'hidden';
        fileInput.name = 'filename';
        fileInput.value = '/alarm007.mp3';
